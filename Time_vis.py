...
# Form implementation generated from reading ui file 'Time_vis.ui'
#
...
class Ui_WindowTime_vis(object):
    def setupUi(self, WindowTime_vis):
        WindowTime_vis.setObjectName("WindowTime_vis")
        WindowTime_vis.resize(1019, 672)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/Users/Calvin Pfob/Documents/guiDevelopment/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        WindowTime_vis.setWindowIcon(icon)
        WindowTime_vis.setIconSize(QtCore.QSize(25, 25))
        self.customerPage = QtWidgets.QWidget(WindowTime_vis)
...
"image: url(:/icon/鸣人头像.jpg);")
        ...
        self.orderlabel.setGeometry(QtCore.QRect(30, 10, 251, 61))
        ...
        self.frame_16.setGeometry(QtCore.QRect(320, 10, 81, 71))
        ...
        self.widget_2.load(QtCore.QUrl("file:///image2.html"))
...
"border-radius:20px;")
        ...
        WindowTime_vis.setCentralWidget(self.customerPage)

        self.retranslateUi(WindowTime_vis)
        QtCore.QMetaObject.connectSlotsByName(WindowTime_vis)

    def retranslateUi(self, WindowTime_vis):
        _translate = QtCore.QCoreApplication.translate
        WindowTime_vis.setWindowTitle(_translate("WindowTime_vis", "E-Vehicle Share System"))
        self.homelabel.setText(_translate("WindowTime_vis", ">HOME<"))
        self.returnlabel.setText(_translate("WindowTime_vis", ">RETURN<"))
        self.title.setText(_translate("WindowTime_vis", "Data visualisation"))
        self.orderlabel.setText(_translate("WindowTime_vis", "Peak heat map of \n"
" vehicle usage"))
