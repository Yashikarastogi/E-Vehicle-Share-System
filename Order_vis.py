...
# Form implementation generated from reading ui file 'Order_vis.ui'
#
...
class Ui_WindowOrder_vis(object):
    def setupUi(self, WindowOrder_vis):
        WindowOrder_vis.setObjectName("WindowOrder_vis")
        WindowOrder_vis.resize(1019, 665)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/Users/Calvin Pfob/Documents/guiDevelopment/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        WindowOrder_vis.setWindowIcon(icon)
        WindowOrder_vis.setIconSize(QtCore.QSize(25, 25))
        self.customerPage = QtWidgets.QWidget(WindowOrder_vis)
...
"image: url(:/icon/鸣人头像.jpg);")
        ...
        self.orderlabel.setGeometry(QtCore.QRect(30, 10, 241, 31))
        ...
        self.frame_8.setGeometry(QtCore.QRect(320, 10, 71, 61))
...
"border-radius:20px;")
        ...
        WindowOrder_vis.setCentralWidget(self.customerPage)

        self.retranslateUi(WindowOrder_vis)
        QtCore.QMetaObject.connectSlotsByName(WindowOrder_vis)

    def retranslateUi(self, WindowOrder_vis):
        _translate = QtCore.QCoreApplication.translate
        WindowOrder_vis.setWindowTitle(_translate("WindowOrder_vis", "E-Vehicle Share System"))
        self.homelabel.setText(_translate("WindowOrder_vis", ">HOME<"))
        self.returnlabel.setText(_translate("WindowOrder_vis", ">RETURN<"))
        self.title.setText(_translate("WindowOrder_vis", "Data visualisation"))
        self.orderlabel.setText(_translate("WindowOrder_vis", "The Order statistics"))
